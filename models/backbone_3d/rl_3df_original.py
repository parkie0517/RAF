...
class RL3DFBackbone_knngate(nn.Module):
    def __init__(self, cfg):
        ...
        # to BEV
        list_bev_channel = cfg_model.BACKBONE.TO_BEV.CHANNEL # [256, 256, 256]
        list_bev_kernel = cfg_model.BACKBONE.TO_BEV.KERNEL_SIZE # [3, 6, 12]
        list_bev_stride = cfg_model.BACKBONE.TO_BEV.STRIDE # [1, 2, 4]
        list_bev_padding = cfg_model.BACKBONE.TO_BEV.PADDING # [1, 2, 4]
