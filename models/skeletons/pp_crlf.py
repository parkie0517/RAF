...
# editted by HJ
# Added camera branch to original l4dr's skeleton code
import os
import torch
...
class PointPillar_CRLF(nn.Module): # hj
    """
    fusion of crl in bev space
    """
    ...
    def forward(self, batch_dict):
        ...
        batch_dict['camera_spatial_features'] = images.permute(0, 1, 3, 2) # [4, 64, 240, 40] -> [4, 64, 40, 240]
        # self.fuser
        ### --------------- Camera Branch --------------- ###
        ...
        batch_dict = self.vfe(batch_dict) # Multi-Modal Encoding (MME)
