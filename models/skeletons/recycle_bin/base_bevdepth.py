...
from models.base_lss_fpn.base_lss_fpn import BaseLSSFPN
from models.heads.bev_depth_head import BEVDepthHead
...
class BaseBEVDepth(nn.Module):
    ...
    def __init__(self, backbone_conf, head_conf, is_train_depth=False):
        ...
        self.backbone = BaseLSSFPN(**backbone_conf) # 인코더 + fpn + lss
        self.head = BEVDepthHead(**head_conf) # head
