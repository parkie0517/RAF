"""
* copied from 'models/backbone_2d/base_bev_backbone.py'
* 'base_bev_backbone.py' was too long. the files includes multiple classes that are not even used.
* this is a file that only contains 'BaseBEVBackbone_MF' class which is what l4dr needs.
"""
...
class BaseBEVBackbone_MF_L4DR(nn.Module):
