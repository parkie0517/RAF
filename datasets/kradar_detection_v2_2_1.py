...
class KRadarDetection_v2_2_1(Dataset):
    """
    ...
    def get_dict_cam_calib_from_yml(self):
        ...
        noise = self.cam_calib.noise
        dict_cam_calib[key_name] = get_matrices_from_dict_calib_noise(dict_temp, noise) # img_size, intrinsics, distortion, T_ldr2cam
...
if __name__ == '__main__':
    kradar_detection = KRadarDetection_v2_2_1(split='all')
